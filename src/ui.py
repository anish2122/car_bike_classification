...
def classify():
    ...
    frame=CTkFrame(master=app,fg_color="transparent",border_color="black",border_width=2)
...
button_to_select = CTkButton(master=app, text = "Choose file", fg_color = "red", command = selectfile)
button_to_select.pack(padx = 5, pady = 5)
button_to_select.place(relx = 0.4, rely = 0.9,anchor="center")

classify_button=CTkButton(master=app,text="Classify",fg_color="purple",command=classify)
